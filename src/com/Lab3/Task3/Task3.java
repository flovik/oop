...
public class Task3 {
    public static void main(String[] args) {
        String s = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam in congue diam. " +
                "Morbi convallis metus ante, sed porta massa rutrum ac. " +
                ...
                " Nunc vitae rutrum arcu. Etiam et tincidunt lectus. " +
                "Nam nec tristique risus. Proin ut tellus consectetur, tincidunt lacus lobortis, interdum orci." +
                ...
                "Aenean eleifend urna ut tortor suscipit vulputate at ac odio. Praesent libero est, placerat vitae fringilla eu, dictum ut orci. " +
                "Suspendisse mauris arcu, tempor.";
